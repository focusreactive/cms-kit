...
export async function down({ db, payload, req }: MigrateDownArgs): Promise<void> {
  await db.execute(sql`
   ALTER TABLE "page_variants_blocks_hero_actions" DISABLE ROW LEVEL SECURITY;
  ALTER TABLE "page_variants_blocks_hero" DISABLE ROW LEVEL SECURITY;
  ALTER TABLE "page_variants_blocks_text_section" DISABLE ROW LEVEL SECURITY;
  ALTER TABLE "page_variants_blocks_content" DISABLE ROW LEVEL SECURITY;
  ALTER TABLE "page_variants_blocks_faq_items" DISABLE ROW LEVEL SECURITY;
  ALTER TABLE "page_variants_blocks_faq" DISABLE ROW LEVEL SECURITY;
  ALTER TABLE "page_variants_blocks_testimonials_list_testimonial_items" DISABLE ROW LEVEL SECURITY;
  ALTER TABLE "page_variants_blocks_testimonials_list" DISABLE ROW LEVEL SECURITY;
  ALTER TABLE "page_variants_tenants" DISABLE ROW LEVEL SECURITY;
  ALTER TABLE "page_variants" DISABLE ROW LEVEL SECURITY;
  ALTER TABLE "page_variants_locales" DISABLE ROW LEVEL SECURITY;
  ALTER TABLE "page_variants_rels" DISABLE ROW LEVEL SECURITY;
